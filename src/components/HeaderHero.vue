      ...
      <div class="container">
        <div class="nav-left">
          <router-link to="/" class="nav-item" :class="{'hide': isOpenedInIFrame}">
            <img src="" class="app-logo" /> <p class="">Master<span>Nodeum</span></p>
          </router-link>
        </div>
        ...
        <div class="modal-card">
          ...
          <section class="modal-card-body">
            <div class="content">
              ...
              <p style="padding-bottom: 10px">Styling of the application was done with <a href="http://bulma.io/" target="_blank">Bulma</a> (Flexbox based CSS framework) and SASS.  <a href="" target="_blank"></a> </p>
            </div>
          </section>
